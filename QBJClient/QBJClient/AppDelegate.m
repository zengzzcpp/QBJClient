...
//    mainView = [[MainDirViewController alloc] initWithNibName:@"MainDirViewController" bundle:nil];
//    [self.window addSubview:mainView.view];
//    self.window.rootViewController = mainView;
    
    MainDirectoryViewController *first = [[MainDirectoryViewController alloc] initWithStyle:UITableViewStylePlain];
